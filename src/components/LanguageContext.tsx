...
const translations: Record<Language, Record<string, string>> = {
  ...
  te: {
    ...
    manufacturer_text: "మేము అహ్మదాబాద్, సూరత్ మరియు హైదరాబాద్‌లోని అగ్రశ్రేణి తయారీదారులతో ప్రత్యక్ష సంబంధాలను కలిగి ఉన్నాము, దీని ద్వారా మీకు తాజా ట్రెండ్‌లను ఉత్తమ హోల్‌సేల్ ధరలకు అందిస్తున్నాము.",
