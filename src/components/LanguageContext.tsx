...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    manufacturer_text: "We maintain strong direct connections with top manufacturers from Ahmedabad, Surat, and Hyderabad, ensuring we bring you the latest trends at the best wholesale prices.",
  ...
  hi: {
    ...
    manufacturer_text: "हम अहमदाबाद, सूरत और हैदराबाद के शीर्ष निर्माताओं के साथ सीधे संबंध बनाए रखते हैं, यह सुनिश्चित करते हुए कि हम आपके लिए सर्वोत्तम थोक कीमतों पर नवीनतम रुझान लाते हैं।",
  ...
  te: {
    hero_title: "25 ఏళ్ల హెూల్ సేల్ అత్యున్నత ప్రమాణాలు",
    hero_subtitle: "ప్రీమియం లేడీస్ వేర్ కోసం ప్రత్యేక హెూల్ సేల్ డీలర్లు",
    ...
    about_text: "25 సంవత్సరాలకు పైగా, మోహన్ కృష్ణ గార్మెంట్స్ & క్లాత్ విజయవాడలోని హెూల్ సేల్ గార్మెంట్ పరిశ్రమలో ఒక మూలస్తంభంగా ఉంది. మేము ఈ ప్రాంతంలోని రిటైలర్లకు అత్యంత నాణ్యమైన మహిళల దుస్తులను అందించడంలో నైపుణ్యం కలిగి ఉన్నాము.",
    manufacturer_text: "మేము అహ్మదాబాద్, సూరత్ మరియు హైదరాబాద్‌లోని అగ్రశ్రేణి తయారీదారులతో ప్రత్యక్ష సంబంధాలను కలిగి ఉన్నాము, దీని ద్వారా మీకు తాజా ట్రెండ్‌లను ఉత్తమ హెూల్ సేల్ ధరలకు అందిస్తున్నాము.",
    ...
    wholesale_tag: "హెూల్ సేల్ మాత్రమే",
