...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    manufacturer_text: "From our humble beginnings, we have grown to source directly from manufacturers in Ahmedabad & Surat, serving hundreds of retailers.",
  ...
  hi: {
    ...
    manufacturer_text: "हमारी विनम्र शुरुआत से, हम अहमदाबाद और सूरत के निर्माताओं से सीधे सोर्स करने के लिए विकसित हुए हैं, और सैकड़ों खुदरा विक्रेताओं की सेवा कर रहे हैं।",
  ...
  te: {
    ...
    manufacturer_text: "మా సాధారణ ప్రారంభం నుండి, మేము అహ్మదాబాద్ మరియు సూరత్ తయారీదారుల నుండి నేరుగా కొనుగోలు చేసే స్థాయికి ఎదిగాము, వందలాది రిటైలర్లకు సేవలు అందిస్తున్నాము.",
