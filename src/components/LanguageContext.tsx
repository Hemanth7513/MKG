...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    about_text: "Mohan Krishna Garments & Cloth has been a pillar of the wholesale garment industry in Vijayawada. We specialize in providing the highest quality women's wear to retailers across the region.",
    manufacturer_text: "From our humble beginnings, we have grown to source directly from manufacturers in Ahmedabad, Surat & Hyderabad, serving hundreds of retailers.",
  ...
  hi: {
    ...
    about_intro_title: "हमारी कहानी",
    about_text: "मोहन कृष्णा गारमेंट्स एंड क्लॉथ विजयवाड़ा में थोक परिधान उद्योग का एक स्तंभ रहा है। हम क्षेत्र भर के खुदरा विक्रेताओं को उच्चतम गुणवत्ता वाले महिला परिधान प्रदान करने में विशेषज्ञ हैं।",
    manufacturer_text: "हमारी विनम्र शुरुआत से, हम अहमदाबाद, सूरत और हैदराबाद के निर्माताओं से सीधे सोर्स करने के लिए विकसित हुए हैं, और सैकड़ों खुदरा विक्रेताओं की सेवा कर रहे हैं।",
  ...
  te: {
    ...
    about_intro_title: "మా కథ",
    about_text: "మోహన్ కృష్ణ గార్మెంట్స్ & క్లాత్ విజయవాడలోని హోల్ సేల్ గార్మెంట్ పరిశ్రమలో ఒక మూలస్తంభంగా ఉంది. మేము ఈ ప్రాంతంలోని రిటైలర్లకు అత్యంత నాణ్యమైన మహిళల దుస్తులను అందించడంలో నైపుణ్యం కలిగి ఉన్నాము.",
    manufacturer_text: "మా సాధారణ ప్రారంభం నుండి, మేము అహ్మదాబాద్, సూరత్ మరియు హైదరాబాద్ తయారీదారుల నుండి నేరుగా కొనుగోలు చేసే స్థాయికి ఎదిగాము, వందలాది రిటైలర్లకు సేవలు అందిస్తున్నాము.",
